...
.directive('jsonFormatter', ['RecursionHelper', function (RecursionHelper) {
  ...
  return {
    templateUrl: './app/shared/json/json-formatter.html',
    restrict: 'E',
    replace: true,
    scope: {
      json: '=',
