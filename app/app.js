...
require('../assets/js/ng-table-to-csv');
require('sweetalert');
...
********************************************************************/
angular
.module('gmae', ['ui.router', 'angular-jwt', 'shared', 'components', 'ui.bootstrap', 
				'jsonFormatter', 'yaru22.angular-timeago', 'ngFileUpload', 'hc.marked', 'highcharts-ng', 'ngTableToCsv'])
